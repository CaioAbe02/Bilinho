...
class InstitutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post institutions_url, params: { institution: { cnpj: @institution.cnpj, nome: @institution.nome, tipo: @institution.tipo } }, as: :json
    end
  ...
  test "should update institution" do
    patch institution_url(@institution), params: { institution: { cnpj: @institution.cnpj, nome: @institution.nome, tipo: @institution.tipo } }, as: :json
    assert_response 200
  end
